...
/**
 * @class       Paypal_Shopping_Cart_For_WordPress_Html_output_MailChimp_MCAPI
 * @version	1.0.0
 * @package	paypal-shopping-cart-for-wordpress
 * @category	Class
 * @author      johnny manziel <phpwebcreators@gmail.com>
 */
class Paypal_Shopping_Cart_For_WordPress_MailChimp_MCAPI {
     ...
     */
    function Paypal_Shopping_Cart_For_WordPress_MailChimp_MCAPI($apikey, $secure = false) {
        $this->secure = $secure;
